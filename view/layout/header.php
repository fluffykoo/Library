            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=fantasy">Livres Fantasy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=romance">Livres Romance</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=theatre">Livres Théatre</a>
                        </li>
                        <li class="nav-item">
